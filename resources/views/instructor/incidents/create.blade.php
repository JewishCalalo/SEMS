    ...
    <div class="py-12 bg-rose-50/40">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('instructor.incidents.store') }}" class="space-y-6" enctype="multipart/form-data" id="incidentForm">
                        @csrf
                ...
                .then(data => {
                    ...
                    if (data && data.success) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Success!',
                            text: data.message || 'Incident report submitted successfully.',
                            confirmButtonColor: '#dc2626'
                        }).then(() => {
                            window.location.href = '{{ route('instructor.incidents.index') }}';
                        });
