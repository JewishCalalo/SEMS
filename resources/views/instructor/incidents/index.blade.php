                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    ...
                                                    <div class="flex items-center space-x-3">
                                                        ...
                                                        @if($thumbUrl)
                                                            <button type="button" onclick="showImageModal('{{ $thumbUrl }}')" class="ml-3 focus:outline-none">
                                                                <img src="{{ $thumbUrl }}" alt="attachment" class="w-10 h-10 object-cover rounded border" />
                                                            </button>
                                                        @endif
                                                    </div>
                                                </div>
