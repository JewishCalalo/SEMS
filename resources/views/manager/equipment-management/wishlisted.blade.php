                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    @endif
                                                    <div>
                                                        <div class="text-sm font-medium text-gray-900">{{ trim(($item->brand ? $item->brand : '').' '.($item->model ? $item->model : '')) ?: 'No brand/model' }}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    <div class="flex items-center space-x-2">
                                                        <span class="font-medium">{{ $item->quantity_available }}</span>
