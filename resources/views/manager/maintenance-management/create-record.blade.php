        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-200">
                <div class="p-6 sm:p-8">
                    ...
                    <form method="POST" action="{{ route('maintenance-management.store-record', $equipment) }}" class="space-y-8" id="maintenanceForm" novalidate>
                        @csrf
                        @if($errors->any())
                            @php
                                $messages = [];
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($equipment->instances as $inst)
                                            <tr class="hover:bg-green-50/30 transition-colors duration-150">
                                                ...
                                                <td class="px-6 py-4">
                                                    <select name="instances[{{ $inst->id }}][condition]" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white">
                                                ...
                                                <td class="px-6 py-4">
                                                    <input type="text" name="instances[{{ $inst->id }}][notes]" placeholder="Optional notes for this instance..." class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500">
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                        ...
                        <div class="bg-emerald-50/60 p-6 rounded-xl border border-green-100 mb-8">
                            ...
                            <textarea name="notes" id="notes" rows="4"
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <i class="fas fa-exclamation-circle mr-1"></i>
                                    {{ $message }}
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-8 border-t border-gray-200">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3">
                                ...
                                <x-form-button type="submit" variant="success" icon="fas fa-save">Create Maintenance Record</x-form-button>
                            </div>
                        </div>
                    </form>
                </div>
