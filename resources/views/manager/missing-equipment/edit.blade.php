                    ...
                    <form method="POST" action="{{ route('missing-equipment.update', $stolenLostEquipment) }}" class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700">
                                {{ $stolenLostEquipment->equipmentInstance->equipment->display_name }} - 
                                {{ $stolenLostEquipment->equipmentInstance->equipment->category->name }} 
                                (Instance: {{ $stolenLostEquipment->equipmentInstance->instance_code }})
                            </div>
                        </div>
