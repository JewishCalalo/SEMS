<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Lost and Missing Equipments Management') }}
        </h2>
    </x-slot>
                                ...
                                <thead class="bg-red-600">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wider">
                                            <a href="{{ request()->fullUrlWithQuery(['sort' => 'incident_date', 'direction' => request('sort') === 'incident_date' && request('direction') === 'asc' ? 'desc' : 'asc']) }}" class="flex items-center space-x-1 text-white hover:text-gray-200">
                                    ...
                                    @foreach($stolenLostItems as $item)
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                {{ $item->incident_date->format('M d, Y') }}
                                            </td>
        ...
        function openGenerateReportModal() {
            Swal.fire({
                ...
                html: `
                    ...
                    <form id="reportForm" method="GET" action="{{ route('missing-equipment.generate-pdf') }}" class="space-y-4">
