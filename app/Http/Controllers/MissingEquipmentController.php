...
class MissingEquipmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $viewPath = auth()->user()->isAdmin() ? 'admin.missing-equipment.index' : 'manager.missing-equipment.index';
    ...
    public function create()
    {
        ...
        $viewPath = auth()->user()->isAdmin() ? 'admin.missing-equipment.create' : 'manager.missing-equipment.create';
    ...
    public function show(MissingEquipment $stolenLostEquipment)
    {
        ...
        $viewPath = auth()->user()->isAdmin() ? 'admin.missing-equipment.show' : 'manager.missing-equipment.show';
    ...
    public function edit(MissingEquipment $stolenLostEquipment)
    {
        ...
        $viewPath = auth()->user()->isAdmin() ? 'admin.missing-equipment.edit' : 'manager.missing-equipment.edit';
