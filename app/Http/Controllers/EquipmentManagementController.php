...
class EquipmentManagementController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $viewPath = $this->getViewPath('equipment-management', 'index');
    ...
    public function create(Request $request)
    {
        ...
        $viewPath = $this->getViewPath('equipment-management', 'create');
    ...
    public function show(Equipment $equipment)
    {
        ...
        $viewPath = $this->getViewPath('equipment-management', 'show');
    ...
    public function edit(Equipment $equipment)
    {
        ...
        $viewPath = $this->getViewPath('equipment-management', 'edit');
    ...
    public function maintenance(Equipment $equipment)
    {
        ...
        $viewPath = auth()->user()->isAdmin() ? 'admin.equipment-management.maintenance' : 'manager.equipment-management.maintenance';
        return view($viewPath, compact('equipment', 'maintenanceRecords'));
    }
    ...
    public function reports()
    {
        ...
        $viewPath = auth()->user()->isAdmin() ? 'admin.equipment-management.reports' : 'manager.equipment-management.reports';
    ...
    public function exportExcel(Request $request)
    {
        ...
        $rows = [];
        $rows[] = ['Name', 'Brand', 'Model', 'Category', 'Type', 'Available', 'Total'];
    ...
    public function wishlisted(Request $request)
    {
        ...
        $viewPath = auth()->user()->isAdmin() ? 'admin.equipment-management.wishlisted' : 'manager.equipment-management.wishlisted';
