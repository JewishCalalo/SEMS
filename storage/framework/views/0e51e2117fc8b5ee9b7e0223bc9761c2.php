...
<?php endif; ?>
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-200">
                <div class="p-6 sm:p-8">
                    ...
                    <form method="POST" action="<?php echo e(route('maintenance-management.store-record', $equipment)); ?>" class="space-y-8" id="maintenanceForm" novalidate>
                        <?php echo csrf_field(); ?>
                        <?php if($errors->any()): ?>
                            <?php
                                $messages = [];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__currentLoopData = $equipment->instances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="hover:bg-green-50/30 transition-colors duration-150">
                                                ...
                                                <td class="px-6 py-4">
                                                    <select name="instances[<?php echo e($inst->id); ?>][condition]" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white">
                                                ...
                                                <td class="px-6 py-4">
                                                    <input type="text" name="instances[<?php echo e($inst->id); ?>][notes]" placeholder="Optional notes for this instance..." class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500">
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                        ...
                        <div class="bg-emerald-50/60 p-6 rounded-xl border border-green-100 mb-8">
                            ...
                            <textarea name="notes" id="notes" rows="4"
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500"><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Submit Section -->
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-8 border-t border-gray-200">
                            <div class="text-sm text-gray-600"><span class="text-green-600 font-semibold">*</span> Required fields</div>
...
<?php endif; ?>
                                <?php if (isset($component)) { $__componentOriginalbb660c7d3380b22758129b879204cbaa = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbb660c7d3380b22758129b879204cbaa = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-button','data' => ['type' => 'submit','variant' => 'success','icon' => 'fas fa-save']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'success','icon' => 'fas fa-save']); ?>Create Maintenance Record <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbb660c7d3380b22758129b879204cbaa)): ?>
<?php $attributes = $__attributesOriginalbb660c7d3380b22758129b879204cbaa; ?>
<?php unset($__attributesOriginalbb660c7d3380b22758129b879204cbaa); ?>
...
<?php endif; ?>
<?php /**PATH C:\SEMSv25\SEMS\resources\views\manager\maintenance-management\create-record.blade.php ENDPATH**/ ?>