...
<body>
    <div class="header">
        <img src="<?php echo e(public_path('images/UB_logo2.png')); ?>" alt="University of Baguio Logo">
    ...
    <div class="filters">
        ...
        <p><strong>Date From:</strong> <?php echo e($filters['date_from'] ?? ''); ?> &nbsp; <strong>Date To:</strong> <?php echo e($filters['date_to'] ?? ''); ?></p>
        <?php if(!empty($filters['owner'])): ?><p><strong>Owner:</strong> <?php echo e($filters['owner']); ?></p><?php endif; ?>
    </div>
    <?php endif; ?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($incident->student_id ?? 'N/A'); ?></td>
...
<?php /**PATH C:\SEMSv25\SEMS\resources\views\pdf\incidents-report.blade.php ENDPATH**/ ?>