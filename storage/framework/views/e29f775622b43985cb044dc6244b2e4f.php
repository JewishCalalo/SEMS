...
<?php $component->withAttributes([]); ?>
    <!-- MANAGER CREATE VIEW MARKER -->
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Add New Equipment')); ?>

        </h2>
        <div class="text-xs text-green-600">MANAGER CREATE VIEW</div>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php /**PATH C:\SEMSv25\SEMS\resources\views\manager\equipment-management\create.blade.php ENDPATH**/ ?>