                    ...
                    <form method="POST" action="<?php echo e(route('missing-equipment.update', $stolenLostEquipment)); ?>" class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700">
                                <?php echo e($stolenLostEquipment->equipmentInstance->equipment->display_name); ?> - 
                                <?php echo e($stolenLostEquipment->equipmentInstance->equipment->category->name); ?> 
                                (Instance: <?php echo e($stolenLostEquipment->equipmentInstance->instance_code); ?>)
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc list-inside space-y-1">
                                ...
                                <li>Equipment instance cannot be changed after creation</li>
                                <li>Replacement date is only required when status is 'replaced'</li>
    ...
    <script>
        // Show/hide replacement date based on replacement status
        document.getElementById('replacement_status').addEventListener('change', function() {
            ...
            if (this.value === 'replaced') {
                replacementDateField.required = true;
                replacementDateField.disabled = false;
            } else {
                replacementDateField.required = false;
                replacementDateField.disabled = false;
            }
        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const replacementStatus = document.getElementById('replacement_status');
            const replacementDateField = document.getElementById('replacement_date');
            
            if (replacementStatus.value === 'replaced') {
                replacementDateField.required = true;
            } else {
                replacementDateField.required = false;
            }
...
<?php endif; ?>
<?php /**PATH C:\SEMSv25\SEMS\resources\views\manager\missing-equipment\edit.blade.php ENDPATH**/ ?>