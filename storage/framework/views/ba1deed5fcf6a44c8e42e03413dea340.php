    ...
    <script>
        function openInstructorReservationsReport() {
            Swal.fire({
                ...
                <form id="reportForm" method="POST" action="<?php echo e(route('instructor.reports.export')); ?>" target="_blank">
...
<?php /**PATH C:\SEMSv25\SEMS\resources\views\instructor\reservations\index.blade.php ENDPATH**/ ?>