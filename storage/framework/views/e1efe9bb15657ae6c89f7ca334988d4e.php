...
<?php endif; ?>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Instance Code</th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Category</th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Reason</th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Discarded By</th>
    ...
    <script>
        ...
        window.openReportModal = function() {
            ...
            // Enable Equipment Type only when Category is selected (mirror admin behavior)
        ...
        // Function to clear all filters and refresh the table
        function clearFilters() {
            document.getElementById('filterForm').reset();
            // Optionally, you can redirect to the current page without parameters
        ...
        // Initialize Category → Equipment Type dependency for Search/Filter (manager)
        (function(){
        ...
        // AJAX form submission for discarded equipment
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('filterForm');
            const clearBtn = document.getElementById('discardedClearBtn');
            const toggleKey = 'discardedFilterToggle';
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv21\resources\views/manager/maintenance-management/discarded.blade.php ENDPATH**/ ?>