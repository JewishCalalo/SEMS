...
<?php endif; ?>
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    <?php endif; ?>
                                                    <div>
                                                        <div class="text-sm font-medium text-gray-900"><?php echo e(trim(($item->brand ? $item->brand : '').' '.($item->model ? $item->model : '')) ?: 'No brand/model'); ?></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="text-sm text-gray-500 ml-1">wishes</span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    <div class="flex items-center space-x-2">
                                                        <span class="font-medium"><?php echo e($item->quantity_available); ?></span>
                                                        <span class="text-gray-400">/</span>
                                                        <span><?php echo e($item->quantity_total); ?></span>
                    ...
                    <?php else: ?>
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-500 mb-6">No equipment matches your search criteria. Try adjusting your filters.</p>
                            <a href="<?php echo e(route('equipment-management.index')); ?>" 
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const distributionCtx = document.getElementById('wishlistDistributionChart');
            if (distributionCtx) {
                const raw = <?php echo json_encode($allEquipment ?? [], 15, 512) ?>;
                // Coerce to array safely if Laravel returns keyed object
                const equipment = Array.isArray(raw) ? raw : Object.values(raw || {});
                
                console.log('Equipment data:', equipment);
                
                if (!Array.isArray(equipment) || equipment.length === 0) {
                    distributionCtx.parentElement.innerHTML = '<div class="flex items-center justify-center h-full text-gray-500"><p>No wishlisted equipment data available</p></div>';
                    return;
                }
                ...
                // Sort equipment by wishlist count and take top 8
            ...
            if (topWishlistedCtx) {
                ...
                const topChart = new Chart(topWishlistedCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: counts,
                            backgroundColor: [
                                '#ef4444','#f97316','#eab308','#22c55e','#3b82f6','#8b5cf6','#06b6d4','#84cc16'
                            ],
                            borderColor: '#ffffff',
                            borderWidth: 2
                        }]
                ...
                // Build explicit legend with full equipment names and counts
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv21\resources\views/manager/equipment-management/wishlisted.blade.php ENDPATH**/ ?>