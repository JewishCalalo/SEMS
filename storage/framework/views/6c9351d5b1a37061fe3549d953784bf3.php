            ...
            Swal.fire({
                ...
                html: `
                    ...
                    <form id="reportForm" action="<?php echo e(route('maintenance-management.generate-discarded-report')); ?>" method="GET" class="space-y-4">
                        ...
                        <!-- Equipment Filter -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Equipment Name (Optional)</label>
                            <input type="text" name="equipment" placeholder="Filter by equipment name..." 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv21\resources\views/admin/maintenance-management/discarded.blade.php ENDPATH**/ ?>