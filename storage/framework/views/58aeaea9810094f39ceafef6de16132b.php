...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Lost and Missing Equipments Management')); ?>
...
<?php endif; ?>
            ...
            <div class="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 p-6 rounded-lg shadow-sm mb-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Manage Lost and Missing Equipments</h3>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <button onclick="openGenerateReportModal()" 
                            ...
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 012-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                    ...
                    <div id="missingTableWrapper" class="overflow-x-auto">
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
                            ...
                            <div id="actionLegendContent" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div class="flex flex-col items-center text-center">
                                    ...
                                    <span class="text-sm text-gray-700">Mark Replaced</span>
                                ...
                                <div class="flex flex-col items-center text-center">
                                    ...
                                    <span class="text-sm text-gray-700">Mark Not Replaced</span>
                                ...
                                <thead class="bg-red-600">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wider">
                                            <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'incident_date', 'direction' => request('sort') === 'incident_date' && request('direction') === 'asc' ? 'desc' : 'asc'])); ?>" class="flex items-center space-x-1 text-white hover:text-gray-200">
                                                <span>Incident Date</span>
                                                <?php if(request('sort') === 'incident_date'): ?>
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e(request('direction') === 'asc' ? 'M5 15l7-7 7 7' : 'M19 9l-7 7-7-7'); ?>"></path>
                                                    </svg>
                                                <?php endif; ?>
                                            </a>
                                        </th>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wider">Incident Type</th>
                                        <th class="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wider">Replacement Status</th>
                                    ...
                                    <?php $__currentLoopData = $stolenLostItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                <?php echo e($item->incident_date->format('M d, Y')); ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div>
                                                    <div class="text-sm font-medium text-gray-900">
                                                        <?php echo e($item->borrower_name); ?>

                                                    </div>
                                                    <div class="text-sm text-gray-500">
                                                        <?php echo e($item->borrower_email); ?>
                        ...
                        <?php else: ?>
                            <div class="text-center py-12">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900">No stolen/lost equipment records</h3>
                                <p class="mt-1 text-sm text-gray-500">Missing equipment records are automatically created when items are marked as lost during the return process.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <script>
        ...
        function openGenerateReportModal() {
            Swal.fire({
                ...
                html: `
                    <div class="bg-gradient-to-r from-red-600 to-red-700 text-white p-4 -m-6 mb-4 rounded-t-lg">
                        <h2 class="text-xl font-bold">Generate Missing Equipment Report</h2>
                    </div>
                    <form id="reportForm" method="GET" action="<?php echo e(route('missing-equipment.generate-pdf')); ?>" class="space-y-4">
                    ...
                    <div class="flex justify-between mt-6">
                        ...
                        <button type="button" class="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all transform hover:scale-105" onclick="submitMissingReport()">
                            Generate Report
                        </button>
                    </div>
                `,
            ...
            // Safe global handler to avoid Alpine parsing issues
            window.submitMissingReport = function(){
            ...
            // Enable Equipment Type only when Category is selected
        ...
        (function(){
            ...
            const clearBtn = document.getElementById('missingClearBtn');
            const content = document.getElementById('searchFilterContent');
            const toggleText = document.getElementById('toggleText');
            const toggleIcon = document.getElementById('toggleIcon');
            if (!form) return;
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv21\resources\views/manager/missing-equipment/index.blade.php ENDPATH**/ ?>